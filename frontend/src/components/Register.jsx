    ...
    <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
        <div className='w-full shadow-md rounded max-w-sm bg-white  px-6 mt-6 mb-8'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='mb-4'>
                  <button className='bg-blue-500 font-bold hover:bg-blue-700 text-white px-7 py-3 rounded focus:outline-none' >Register</button>
                </div>
                <p className='text-sm font-medium align-baseline'>Have an account? Please <Link to="/login" 
